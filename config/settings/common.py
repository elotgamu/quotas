# -*- coding: utf-8 -*-
"""
Django settings for quotas project.
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'quotas.contrib.sites.migrations'
}
...
ADMINS = (
    ("""@peter @elotgamu""", 'elotgamu@gmail.com'),
)
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///quotas'),
}
